...
public class CurrencyConverter {
    ...
    public static void Ruppe_to_other(double amt) {
        System.out.println("1 Ruppes = " + 0.013 + " Dollar");
        System.out.println();

        System.out.println(amt + " Ruppes = " + (amt * 0.013) + " Dollar");
        System.out.println();

        System.out.println("1 Ruppes = " + 0.012 + " Euro");
        System.out.println();
        System.out.println(amt + " Ruppes = " + (amt * 0.012) + " Euro");
        System.out.println();

    }

    public static void Dollar_to_other(double amt) {
        System.out.println("1 Dollar = " + 79.37 + " Ruppes");
        System.out.println();
        System.out.println(amt + " Dollar = " + (amt * 79.37) + " Ruppes");
        System.out.println();
    ...
    public static void Euro_to_other(double amt) {
        System.out.println("1 Euro = " + 80.85 + " Ruppes");
        System.out.println();
        System.out.println(amt + " Euro = " + (amt * 80.85) + " Ruppes");
        System.out.println();
